...
function ProfilePictureModal({modalVisible, setModalVisible, openGallery, openCamera}) {
  ...
  useEffect(() => {
    setInnerModalHeight(screenHeight * 0.3); // Set inner modal height to 75% of the screen height
  }, [screenHeight]);
...
<ScrollView 
 ...
 <View style={styles.container}>
   ...
   <AppButton title="Choose from Gallery" onPress={openGallery}/>
